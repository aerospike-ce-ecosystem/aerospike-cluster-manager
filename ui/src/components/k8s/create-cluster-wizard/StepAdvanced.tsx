...
function MonitoringSection({ form, updateForm }: StepAdvancedProps) {
  ...
  const summary = enabled
    ? `Enabled (port ${monitoring.port ?? 9145})`
    : "Disabled"
...
function AclSection({ form, updateForm }: StepAdvancedProps) {
  ...
  const updateRole = (i: number, patch: Partial<ACLRoleSpec>) => {
    const roles = (acl.roles ?? []).map((r, idx) =>
      idx === i ? { ...r, ...patch } : r,
    )
    set({ roles })
  }
  ...
  const updateUser = (i: number, patch: Partial<ACLUserSpec>) => {
    const users = (acl.users ?? []).map((u, idx) =>
      idx === i ? { ...u, ...patch } : u,
    )
    set({ users })
  }
    ...
    <Section title="Security (ACL)" summary={summary}>
      <div className="flex flex-col gap-4">
        ...
        {enabled && (
          <>
            <div className="flex flex-col gap-1.5">
              <Label htmlFor="acl-timeout">
                Admin Policy Timeout (seconds)
              </Label>
              <Input
                id="acl-timeout"
                type="number"
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <Input
                        ...
                        value={role.name}
                        onChange={(e) =>
                          updateRole(i, { name: e.target.value })
                        }
                        placeholder="admin"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
                    <div className="flex flex-col gap-1.5">
                      ...
                      <Input
                        ...
                        value={user.name}
                        onChange={(e) =>
                          updateUser(i, { name: e.target.value })
                        }
                        placeholder="admin"
                      />
                    </div>
                    <div className="flex flex-col gap-1.5">
                      <Label htmlFor={`user-secret-${i}`}>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          updateUser(i, { secretName: e.target.value })
                        }
...
function RollingUpdateSection({ form, updateForm }: StepAdvancedProps) {
  ...
  const active =
    ru.batchSize !== undefined ||
    ru.maxUnavailable !== undefined ||
    Boolean(ru.disablePDB)
  return (
            ...
            <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateRack(i, {
                      id: Number.parseInt(e.target.value, 10) || 1,
                    })
                  }
                />
              </div>
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  value={rack.zone ?? ""}
                  onChange={(e) =>
                    updateRack(i, { zone: e.target.value || null })
                  }
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  value={rack.region ?? ""}
                  onChange={(e) =>
                    updateRack(i, { region: e.target.value || null })
                  }
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <Input
                  ...
                  onChange={(e) =>
                    updateRack(i, { rackLabel: e.target.value || null })
                  }
...
function PodSettingsSection({ form, updateForm }: StepAdvancedProps) {
  ...
  const meta: PodMetadataConfig = ps.metadata ?? {
    labels: null,
    annotations: null,
  }
  ...
  const updateToleration = (i: number, patch: Partial<TolerationConfig>) =>
    set({
      tolerations: tolerations.map((t, idx) =>
        idx === i ? { ...t, ...patch } : t,
      ),
    })
        ...
        <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
          <div className="flex flex-col gap-1.5">
            ...
            <Input
              ...
              onChange={(e) =>
                set({ serviceAccountName: e.target.value || null })
              }
            ...
            <select
              ...
              onChange={(e) =>
                set({
                  podManagementPolicy:
                    (e.target
                      .value as PodSchedulingConfig["podManagementPolicy"]) ||
                    null,
                })
              }
          ...
          {tolerations.map((t, i) => (
            ...
            >
              <Input
                value={t.key ?? ""}
                onChange={(e) =>
                  updateToleration(i, { key: e.target.value || null })
                }
                placeholder="key"
              />
              <select
              ...
              <Input
                value={t.value ?? ""}
                onChange={(e) =>
                  updateToleration(i, { value: e.target.value || null })
                }
                placeholder="value"
              />
              <select
    ...
    <Section title="Sidecars & Init Containers" summary={summary}>
      <div className="flex flex-col gap-4">
        <ContainerList
          ...
          value={form.sidecars ?? []}
          onChange={(next) =>
            updateForm({ sidecars: next.length ? next : undefined })
          }
        />
        <ContainerList
          ...
          onChange={(next) =>
            updateForm({ initContainers: next.length ? next : undefined })
          }
        />
      </div>
    </Section>
...
function NetworkPolicySection({ form, updateForm }: StepAdvancedProps) {
  ...
  const summary =
    np.accessType && np.accessType !== "pod"
      ? `access=${np.accessType}`
      : "Default (pod)"
      ...
      <div className="grid grid-cols-1 gap-3 md:grid-cols-3">
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            onChange={(e) =>
              set({
                accessType: e.target.value as NetworkAccessConfig["accessType"],
              })
            }
            className="h-9 rounded-md border border-gray-300 bg-white px-3 text-sm text-gray-900 dark:border-gray-700 dark:bg-gray-900"
          >
          ...
          <select
            ...
            onChange={(e) =>
              set({
                alternateAccessType:
                  (e.target
                    .value as NetworkAccessConfig["alternateAccessType"]) ||
                  null,
              })
            }
            className="h-9 rounded-md border border-gray-300 bg-white px-3 text-sm text-gray-900 dark:border-gray-700 dark:bg-gray-900"
        ...
        <div className="flex flex-col gap-1.5">
          ...
          <select
            ...
            onChange={(e) =>
              set({
                fabricType:
                  (e.target.value as NetworkAccessConfig["fabricType"]) || null,
              })
            }
            className="h-9 rounded-md border border-gray-300 bg-white px-3 text-sm text-gray-900 dark:border-gray-700 dark:bg-gray-900"
          >
...
function ValidationPolicySection({ form, updateForm }: StepAdvancedProps) {
  ...
  const summary = vp.skipWorkDirValidate
        ...
        <div>
          ...
          <div className="flex flex-col gap-3">
            <KeyValueEditor
              ...
              onChange={(next) =>
                updateForm({ headlessService: { ...hs, labels: next } })
              }
            />
            <KeyValueEditor
              label="Annotations"
              ...
              onChange={(next) =>
                updateForm({ headlessService: { ...hs, annotations: next } })
              }
            />
          </div>
        </div>
        <div>
          ...
          <div className="flex flex-col gap-3">
            <KeyValueEditor
              ...
              onChange={(next) =>
                updateForm({ podService: { ...ps, labels: next } })
              }
            />
            <KeyValueEditor
              label="Annotations"
              ...
              onChange={(next) =>
                updateForm({ podService: { ...ps, annotations: next } })
              }
            />
          </div>
        </div>
    ...
    >
      <label className="flex items-center gap-2">
        <Checkbox
          ...
          onCheckedChange={(v) =>
            updateForm({ enableRackIDOverride: v === true })
          }
        />
    ...
    >
      <label className="flex items-center gap-2">
        <Checkbox
          ...
          onCheckedChange={(v) =>
            updateForm({ enableDynamicConfig: v === true })
          }
        />
